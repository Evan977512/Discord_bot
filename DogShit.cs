...
namespace Evan_discord_01
{
    public class DogShit
    {
        ...
        public async Task Main()
        {
            ...
            await client.LoginAsync(TokenType.Bot, "MTAyODA5NDQyNzkyMDYwOTM0Mw.GDdkXw.YXY0f4soWl3DsEc9mgZ8dALeUz0jdZo99W-cRQ"); //봇의 토큰을 사용해 서버에 로그인
        ...
        private async Task OnClientMessage(SocketMessage arg)
        {
            ...
            if (!(message.HasCharPrefix('!', ref pos) || message.HasMentionPrefix(client?.CurrentUser, ref pos)) ||
